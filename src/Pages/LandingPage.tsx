      ...
      <section className="banner text-center py-4">
        ...
        <div className="banner-content" style={{ padding: "5rem" }}>
          ...
          <p style={{ marginTop: "1rem", fontSize: "1.2rem", color: "#333" }}>
           ...
           </p>Geo Pick Points is an exciting game that takes you on a virtual scavenger hunt. You can play solo or in teams, exploring interesting locations while collecting points. Whether cooperative or competitive, the goal is fun and adventure!
