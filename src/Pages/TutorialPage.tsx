...
const TutorialPage: React.FC = () => {
    return (
        <div style={{ padding: "20px" }}>
            ...
            <section style={{ marginTop: "20px" }}>
                <h2>Das Spiel</h2>
                <p>   Du bekommst jetzt eine Benachrichtigung in deinem Browser, die dich auffordert, den Standortzugriff zuzulassen. Das ist unbedingt notwendig für das Verwenden der App.  </p>

                <p> Sobald du auf “Zulassen” drückst, solltest du die Karte mit einigen Pick Point (gelb), sowie
                    deinem eigenen Standort (weiß-rot) sehen. Drückst du auf einen Pick Point, so öffnet sich ein Fenster mit einer kurzen Beschreibung des Pick Point, sowie einem Button für das Claimen. </p>


               
                <p> Probiere einen der Pick Points zu Claimen. Du solltest eine Nachricht bekommen, mit der aktuellen Distanz zum Pick Point.
